...
import { UserProfileDropdownGS } from '../../components/home/UserProfileDropdownGS';
...
interface HomeScreenGSProps {
  navigation: any;
}

const HomeScreenGS: React.FC<HomeScreenGSProps> = ({ navigation }) => {
            ...
            <VStack space="lg" alignItems="flex-start">
              <HStack justifyContent="space-between" alignItems="center" width="100%">
                ...
                <Badge
                  ...
                  py="$1"
                >
                  <BadgeText fontSize="$xs" fontWeight="$bold" color={color}>
                    פעיל
                  </BadgeText>
                </Badge>
              </HStack>
                ...
                <Box px="$6" py="$6" position="relative">
                  ...
                  <VStack space="md" alignItems="flex-start" pt="$2">
                    ...
                    <VStack alignItems="flex-start" space="xs">
                      ...
                      >
                        מצא שחקנים • הזמן מגרש • שחק ותהנה
                      </Text>
                    </VStack>
                  </VStack>
                </Box>
